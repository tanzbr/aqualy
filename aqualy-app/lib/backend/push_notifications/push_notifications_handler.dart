...
final parametersBuilderMap =
  ...
  'onboarding_type': ParameterData.none(),
  'signIn': ParameterData.none(),
  'StatsPage': ParameterData.none(),
  'InsightsPage': ParameterData.none(),
  'MedidorDetailsPage': (data) async => ParameterData(
        allParams: <String, dynamic>{},
      ),
  'SettingsPage': ParameterData.none(),
  'addDevice': ParameterData.none(),
  'MedidorSettingsPage': (data) async => ParameterData(
        allParams: <String, dynamic>{},
      ),
};
