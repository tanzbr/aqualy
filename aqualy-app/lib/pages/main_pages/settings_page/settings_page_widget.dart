...
class _SettingsPageWidgetState extends State<SettingsPageWidget> {
  ...
  void initState() {
    ...
    _model.fullNameTextController1 ??=
        TextEditingController(text: FFAppState().loggedUser.nome);
    _model.fullNameFocusNode1 ??= FocusNode();

    _model.fullNameTextController2 ??=
        TextEditingController(text: FFAppState().loggedUser.email);
    ...
    _model.passwordTextController2 ??=
        TextEditingController(text: FFAppState().loggedUser.valorM.toString());
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    ...
                    _model.updateResult =
                        await BackendGroup.updateUserCall.call(
                      id: FFAppState().loggedUser.id,
                      nome: _model.fullNameTextController1.text,
                      senha: _model.passwordTextController1.text,
                      valorM:
                          double.tryParse(_model.passwordTextController2.text),
                      email: FFAppState().loggedUser.email,
                    );

                    _shouldSetState = true;
                    if ((_model.updateResult?.succeeded ?? true)) {
                      FFAppState().loggedUser = UserStruct.maybeFromMap(
