...
import 'onboarding_createaccount_model.dart';
export 'onboarding_createaccount_model.dart';
                  ...
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        ...
                        _model.cadastroResult =
                            await BackendGroup.registerCall.call(
                          nome: _model.fullNameTextController.text,
                          email: _model.emailAddressTextController.text,
                          senha: _model.passwordTextController.text,
                        );

                        _shouldSetState = true;
                        if ((_model.cadastroResult?.succeeded ?? true)) {
                          FFAppState().loggedUser = UserStruct.maybeFromMap(
                              (_model.cadastroResult?.jsonBody ?? ''))!;
